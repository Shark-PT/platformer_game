...
# função para carregar os blocos do terreno
def get_block(size):
...
# Criação da class player com todos os controlos e movimentos associados ao mesmo
...
def main(window):
    ...
    background, bg_image = get_background("Blue.png") #Mudar a imagem de fundo
    ...
    run = True
    while run :
        clock.tick(FPS) # Força o jogo a correr no maximo a 60 FPS
